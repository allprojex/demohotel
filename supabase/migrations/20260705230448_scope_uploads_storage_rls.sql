-- Scope the private 'uploads' bucket by property_id.
-- Object path convention (see admin.uploads.tsx): "<property_id>/<timestamp>_<filename>"
-- The first path segment is the property UUID; require the caller to have
-- property access via can_access_property() for SELECT/INSERT/UPDATE/DELETE,
-- and additionally require an admin role for writes.
