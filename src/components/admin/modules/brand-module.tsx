  ...
  const save = useMutation({
    mutationFn: async (values: BrandFormState) => {
      ...
      const payload: Record<string, unknown> = {
        app_name: values.app_name || "Infinity Techub PMS",
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <Field label="Application name" required>
              <Input
                ...
                placeholder="Infinity Techub PMS"
              />
            </Field>
      ...
      <div className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-4">
            <BrowserTabPreview title={form.app_name || "Infinity Techub PMS"} favicon={form.favicon_url} />
            <Separator />
            <SidebarHeaderPreview
              name={form.app_short_name || form.app_name || "Infinity Techub"}
              logo={form.logo_url}
            />
            <Separator />
            <div>
