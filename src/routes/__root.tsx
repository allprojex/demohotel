...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Infinity Grand Hotel" },
      { name: "description", content: "Enterprise cloud hotel property management system by Infinity Grand Hotel." },
      { property: "og:title", content: "Infinity Grand Hotel" },
      { property: "og:description", content: "Enterprise cloud hotel property management system by Infinity Grand Hotel." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Infinity Grand Hotel" },
      { name: "twitter:description", content: "Enterprise cloud hotel property management system by Infinity Grand Hotel." },
