...
export const Route = createFileRoute("/book/")({
  head: () => ({
    meta: [
      { title: "Book direct — Infinity Grand Hotel" },
      { name: "description", content: "Reserve rooms directly and unlock our best available rate." },
      { property: "og:title", content: "Book direct — Infinity Grand Hotel" },
      ...
      <header className="border-b bg-card/40 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4">
          <Link to="/book" className="flex items-center gap-2">
            ...
            <div>
              <div className="font-display text-sm font-semibold">Infinity Grand Hotel</div>
